...
colorImage = imread('testframe.jpg');
...
%%
% This script showed you how to detect text in an image using the MSER
...
% regions. This code is a good starting point for developing more
% robust text detection algorithms. Note that without further enhancements
% this code can produce reasonable results for a variety of other
